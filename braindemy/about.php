...
<body>
    ...
    <div class="contact">
        <div class="left-side">
            ...
            <br>
            <p>Inspiring entrepreneurs into action. With knowledge, skills, and commitment, Braindemy is on a mission to
             develop a culture of innovation in Kosovo.Braindemy is a training center whose aim is to connect research and development 
             component of scientific field with the business sector, focusing on creating trainings and 
                new job opportunities oriented towards the future, based on knowledge and new technology. </p> <br>
            <p>If you require any further information, feel free to contact us: <br><br>
                <a href="contact.php" style="text-decoration: none; color: blue;"> CONTACT US</a>
            </p>
        </div>
