<div class="footer">
          ...
          <div>
            ...
            <h3 id="shkrimifooter"><a href="project.php">About Braindemy</a></h3>
            <h3 id="shkrimifooter"><a href="trainingpage.php">Training & courses </a></h3>
            <h3 id="shkrimifooter"><a href="events.php">Upcoming events</a></h3>
            <h3 id="shkrimifooter"><a href="about.php"> Co-working spaces</a></h3>
            <h3 id="shkrimifooter"><a href="contact.php"> Contact us </a></h3>
          </div>
          <div>
